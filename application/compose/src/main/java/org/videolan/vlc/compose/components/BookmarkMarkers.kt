...
@Composable
fun VLCBookmarkMarkersLightPreview() {
    VLCTheme(darkTheme = false) {
        VLCBookmarkMarkers(markerFractions = listOf(0f, 0.12f, 0.45f, 0.82f, 1f))
    }
}

@Preview(
    name = "VLCBookmarkMarkers - Dark",
    showBackground = true,
...
@Composable
fun VLCBookmarkMarkersDarkPreview() {
    VLCTheme(darkTheme = true) {
        VLCBookmarkMarkers(markerFractions = listOf(0.08f, 0.32f, 0.68f, 0.94f))
    }
}
