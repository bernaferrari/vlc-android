...
@Preview(
    name = "VLCAudioHeaderTimeLabel - Light",
    showBackground = true,
...
@Composable
fun VLCAudioHeaderTimeLabelLightPreview() {
...
@Preview(
    name = "VLCAudioHeaderTimeLabel - Dark",
    showBackground = true,
...
@Composable
fun VLCAudioHeaderTimeLabelDarkPreview() {
    VLCTheme(darkTheme = true) {
        VLCAudioHeaderTimeLabel(text = "-37:30")
    }
}
