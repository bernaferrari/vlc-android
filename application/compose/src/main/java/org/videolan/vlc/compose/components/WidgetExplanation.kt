...
@Preview(name = "Widget Explanation", showBackground = true)
@Composable
private fun VLCWidgetExplanationDialogContentPreview() {
    VLCWidgetExplanationDialogContent(
        title = "Widget setup",
        sizeText = "Choose a widget size that fits your screen.",
        resizeText = "Long press the widget to resize it.",
        endText = "You can change widget colors from the widget settings.",
        nextText = "Next",
        closeText = "Close",
        sizePreviewCount = 4,
        onClose = {},
        sizePreviewContent = { _, modifier -> PreviewWidgetBlock(modifier) },
        resizePreviewContent = { modifier -> PreviewWidgetBlock(modifier) },
        tapIconContent = { modifier -> PreviewCircle(modifier) },
        themeIconContent = { modifier -> PreviewCircle(modifier) }
    )
}

@Preview(name = "Widget Explanation Dark", showBackground = true, uiMode = Configuration.UI_MODE_NIGHT_YES)
@Composable
private fun VLCWidgetExplanationDialogContentDarkPreview() {
    VLCWidgetExplanationDialogContent(
        title = "Widget setup",
        sizeText = "Choose a widget size that fits your screen.",
        resizeText = "Long press the widget to resize it.",
