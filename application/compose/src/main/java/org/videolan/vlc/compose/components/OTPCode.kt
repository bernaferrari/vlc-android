...
@Preview(name = "OTP Code Light", showBackground = true)
@Composable
private fun VLCOTPCodeScreenPreview() {
    VLCOTPCodeScreen(
        title = "Remote access login attempt",
        subtitle = "If it's you, enter this code on the other device",
        cancelText = "It's not me",
        code = "841927",
        onCancel = {}
    )
}

@Preview(name = "OTP Code Dark", showBackground = true, uiMode = Configuration.UI_MODE_NIGHT_YES)
@Composable
private fun VLCOTPCodeScreenDarkPreview() {
    VLCOTPCodeScreen(
        title = "Remote access login attempt",
        subtitle = "If it's you, enter this code on the other device",
        cancelText = "It's not me",
