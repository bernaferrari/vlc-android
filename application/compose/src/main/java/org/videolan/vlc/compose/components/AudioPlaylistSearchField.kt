...
@Preview(
    name = "VLCAudioPlaylistSearchField - Light",
    showBackground = true,
...
@Composable
fun VLCAudioPlaylistSearchFieldLightPreview() {
...
@Preview(
    name = "VLCAudioPlaylistSearchField - Dark",
    showBackground = true,
...
@Composable
fun VLCAudioPlaylistSearchFieldDarkPreview() {
