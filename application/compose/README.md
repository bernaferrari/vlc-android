...
- Compose-hosted root screens with remaining subpage follow-up:
  - `PreferencesActivity` root settings list plus Casting, Parental Control, and Android Auto subpages (former phone root/Casting/Parental/Android Auto preference Fragments removed; larger `BasePreferenceFragment` subpages still tracked separately)
