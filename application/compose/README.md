...
- **Pointers to host files** (update this list as new hosts land):
  ...
  - Shared playback option rows: `application/vlc-android/src/org/videolan/vlc/gui/helpers/PlayerOptionsDelegate.kt` + `PlayerOptionItemView.kt` (`VLCPlayerOptionItem`; compose-68e; used by audio/video/player remote option panels through PlayerOptionsDelegate)
