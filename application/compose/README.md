...
- Compose player hosts:
  - `AudioPlayerContainerActivity` now instantiates `AudioPlayer` as a bottom-sheet controller inside the `audioplayer.xml` `FrameLayout` host (former XML host path removed; bd compose-55n)
