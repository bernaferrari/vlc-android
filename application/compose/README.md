...
- Compose-hosted root screens with remaining subpage follow-up:
  - `PreferencesActivity` root settings list plus Casting, Parental Control, Remote Access, and Android Auto subpages (former phone root/Casting/Parental/Remote Access/Android Auto preference Fragments removed; larger `BasePreferenceFragment` subpages still tracked separately)
