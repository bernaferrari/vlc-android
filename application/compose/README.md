...
- Compose-hosted root screens:
  - `PreferencesActivity` root settings list plus Interface, Video, Subtitles, Audio, Casting, Parental Control, Remote Access, Android Auto, Advanced, and Optional Features subpages (former phone root and all phone `BasePreferenceFragment` preference subpages removed)
