        ...
        INavigator by Navigator()
{
    ...
    private fun updateIncognitoModeIcon() {
        ...
        toolbarIcon.setImageDrawable(ContextCompat.getDrawable(this, if (incognito) R.drawable.ic_incognito else if (BuildConfig.DEBUG) R.drawable.ic_icon_vlc4 else R.drawable.ic_icon))
