...
class AudioPlayerViews(val root: ConstraintLayout) {
    ...
    val backgroundView: VLCComposeView = root.requireAudioPlayerView(R.id.backgroundView)
    val topGradient: VLCComposeView = root.requireAudioPlayerView(R.id.top_gradient)
    val bottomGradient: VLCComposeView = root.requireAudioPlayerView(R.id.bottom_gradient)
    ...
    val audioRewindBookmark: VLCComposeView? = root.findAudioPlayerView(R.id.audio_rewind_bookmark)
    val audioRewind10: VLCComposeView? = root.findAudioPlayerView(R.id.audio_rewind_10)
    val audioRewindText: VLCComposeView? = root.findAudioPlayerView(R.id.audio_rewind_text)
    val audioForward10: VLCComposeView? = root.findAudioPlayerView(R.id.audio_forward_10)
    val audioForwardText: VLCComposeView? = root.findAudioPlayerView(R.id.audio_forward_text)
    val audioForwardBookmark: VLCComposeView? = root.findAudioPlayerView(R.id.audio_forward_bookmark)
    ...
    val trackInfoContainer: VLCComposeView? = root.findAudioPlayerView(R.id.track_info_container)
}
