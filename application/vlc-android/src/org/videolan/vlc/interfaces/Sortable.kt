...
interface Sortable : PopupMenu.OnMenuItemClickListener {
    ...
    fun sort(v: View) {
        ...
        menu.menu.add(0, R.id.ml_menu_sortby_name, 0, R.string.sortby_name)
        menu.menu.add(0, R.id.ml_menu_sortby_filename, 0, R.string.sortby_filename)
        menu.menu.add(0, R.id.ml_menu_sortby_length, 0, R.string.sortby_length)
        menu.menu.add(0, R.id.ml_menu_sortby_date, 0, R.string.sortby_date)
        menu.menu.add(0, R.id.ml_menu_sortby_last_modified, 0, R.string.sortby_last_modified_date)
        menu.menu.add(0, R.id.ml_menu_sortby_insertion_date, 0, R.string.sortby_insertion)
        menu.menu.add(0, R.id.ml_menu_sortby_number, 0, R.string.sortby_number)
