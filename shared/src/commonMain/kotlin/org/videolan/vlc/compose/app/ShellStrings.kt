...
object ShellStrings {
    ...
    @Composable fun searchNoResult(): String = stringResource(Res.string.search_no_result)
    ...
    @Composable fun decrease(title: String): String = stringResource(Res.string.decrease_value, title)
    @Composable fun increase(title: String): String = stringResource(Res.string.increase_value, title)
    ...
    @Composable fun noVideosMessage(): String = stringResource(Res.string.no_videos_message)
    ...
    @Composable fun noAudioMessage(): String = stringResource(Res.string.no_audio_library_message)
    ...
    @Composable fun mediaActionsManage(): String = stringResource(Res.string.media_actions_manage)
    @Composable fun moreActions(): String = stringResource(Res.string.more_actions)
