...
object MaterialSymbols {
    object Filled {
        ...
        val Warning: MaterialIcon get() = MaterialIcon(filledWarning)
        val Forum: MaterialIcon get() = MaterialIcon(filledForum)
        val Description: MaterialIcon get() = MaterialIcon(filledDescription)
        val Mail: MaterialIcon get() = MaterialIcon(filledMail)
        val Backspace: MaterialIcon get() = MaterialIcon(filledBackspace)
