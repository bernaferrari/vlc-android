...
/*
 * VLC preference key constants.
 *
 * All keys are plain string constants so they can live in common code and be
 * shared across Android, JVM, and any future KMP target.
 *
 * Previously inlined in Settings.kt; moved here so that the DataStore-backed
 * preference layer and any platform code can reference the same keys.
 */
...
const val KEY_OVERRIDE_TV_UI = "override_tv_ui"
...
// Mirror of android.app.Activity.RESULT_FIRST_USER (value = 1).
// Hardcoded so these constants are platform-independent.
const val RESULT_RESCAN = 2          // Activity.RESULT_FIRST_USER + 1
const val RESULT_RESTART = 3         // Activity.RESULT_FIRST_USER + 2
const val RESULT_RESTART_APP = 4     // Activity.RESULT_FIRST_USER + 3
const val RESULT_UPDATE_SEEN_MEDIA = 5   // Activity.RESULT_FIRST_USER + 4
const val RESULT_UPDATE_ARTISTS = 6   // Activity.RESULT_FIRST_USER + 5
